...
export interface RapportResult { adresse: string; sammendrag: string; tg: TGItem[]; positive: string[]; negative: string[]; }
...
type Props = {
  ...
  initialRisk: RapportResult | null;
  initialMegler: string;
  initialPdfUrl: string;
};

export default function AnalyseClient({ finn, initialMetric, initialRisk, initialMegler, initialPdfUrl }: Props) {
